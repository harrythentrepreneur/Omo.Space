...
- No differential harness or sanitized golden fixtures exist yet.
...
- NEXT CONCRETE BUILD STEP: create the differential parity harness and sanitized golden-fixture contract before porting more capabilities. It must run the same fixture through PhonicsMaker and Omo, canonicalize transport-only differences, compare logical outputs and artifacts, and fail closed on quality drift.
