...
- Creator builder infrastructure: issue #63 moved creator-build dispatch off Hetzner through Cloudflare cron -> protected Modal endpoint -> Worker-authoritative atomic claim -> one revision/source-bound ephemeral Hermes build. Issue #65 adds bounded stale-reservation recovery; issue #67 adds safe pre-runtime detail and allowlisted failure-stage evidence. Full issue/PR canary evidence is still pending.
