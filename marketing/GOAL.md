...
- Creator builder infrastructure: issue #63 moved creator-build dispatch off Hetzner through Cloudflare cron -> protected Modal endpoint -> Worker-authoritative atomic claim -> one revision/source-bound ephemeral Hermes build. Issues #65/#67/#69 add recovery, safe failure stages, and immutable-checkout imports; issue #71 enables bounded non-interactive tool approval inside the single-use builder. Full issue/PR canary evidence is still pending.
