...
def dispatch_id_for(submission_id: str, source_sha256: str) -> str:
...
def launch_modal_builder(
    *,
    ...
    if (
        ...
        or dispatch_id != dispatch_id_for(submission_id, source_sha256)
    ):
    ...
    call: Any = function.spawn(submission_id, slug, source_sha256, dispatch_id)
