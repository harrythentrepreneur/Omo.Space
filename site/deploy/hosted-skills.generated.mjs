  ...
  [
    "v02-support-urgency-classifier",
    {
      ...
      "executor": {
        ...
        "temperature": 0.2,
        "timeout_seconds": 120,
        "workflow_instructions": "Transform the supplied bounded input and return only JSON matching the output schema.",
        "workflow_version": "1.0.0"
      },
      "input_adapters": [],
      "input_schema": {
      ...
      "reviewed_source_sha256": "85126e7069bd7d0117a8e2db807e604b4c912281da19e9929ed603dd3941f763",
      "run_price_cents": 10,
