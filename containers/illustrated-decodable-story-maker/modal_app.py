"""Generated Modal contract runtime for illustrated-decodable-story-maker.
...
APP_NAME = 'cognition-illustrated-decodable-story-maker'
WORKFLOW_VERSION = 'illustrated-decodable-story-maker@0.1.0'
EXECUTION_KIND = 'complex_external'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/illustrated_decodable_story_maker')
...
runtime_image = (
    ...
    .apt_install('chromium', 'fonts-liberation', 'ghostscript')
    .uv_pip_install(
        "modal==1.5.0",
        "fastapi==0.109.0",
        "jsonschema==4.26.0",
...
def create_fastapi_app(
    ...
    *,
    ...
    web = FastAPI(title='illustrated-decodable-story-maker', version='0.1.0')
