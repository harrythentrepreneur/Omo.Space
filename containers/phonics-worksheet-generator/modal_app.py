"""Generated Modal contract runtime for phonics-worksheet-generator.
...
APP_NAME = 'cognition-phonics-worksheet-generator'
WORKFLOW_VERSION = 'phonics-worksheet-generator@0.1.0'
EXECUTION_KIND = 'complex_external'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/phonics_worksheet_generator')
...
def create_fastapi_app(
    ...
    *,
    ...
    web = FastAPI(title='phonics-worksheet-generator', version='0.1.0')
