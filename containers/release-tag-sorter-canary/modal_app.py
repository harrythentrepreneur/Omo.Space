"""Generated pure-data parity runtime for release-tag-sorter-canary@1.0.0."""
...
APP_NAME = 'cognition-release-tag-sorter-canary'
WORKFLOW_VERSION = 'release-tag-sorter-canary@1.0.0'
PROFILE_VERSION = '1.0.0'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/release_tag_sorter_canary')
