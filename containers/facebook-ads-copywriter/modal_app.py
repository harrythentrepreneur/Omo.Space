"""Generated Modal contract runtime for facebook-ads-copywriter.
...
APP_NAME = 'cognition-facebook-ads-copywriter'
WORKFLOW_VERSION = 'facebook-ads-copywriter@0.1.0'
EXECUTION_KIND = 'single_llm'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/facebook_ads_copywriter')
...
LIVE_WORKFLOW_INSTRUCTIONS_PATH = None
LIVE_MAX_TOKENS = 1600
LIVE_MAX_INPUT_BYTES = 65536
LIVE_TEMPERATURE = 0.55
LIVE_TIMEOUT_SECONDS = 120
LIVE_INPUT_RATE_PER_MILLION = 0.14
LIVE_OUTPUT_RATE_PER_MILLION = 0.42
LIVE_MODEL_OUTPUT_SCHEMA = {'$schema': 'https://json-schema.org/draft/2020-12/schema', 'additionalProperties': False, 'properties': {'ads': {'items': {'additionalProperties': False, 'properties': {'angle': {'maxLength': 120, 'minLength': 3, 'type': 'string'}, 'cta': {'enum': ['Shop Now', 'Learn More', 'Sign Up', 'Get Offer'], 'type': 'string'}, 'description': {'maxLength': 160, 'minLength': 3, 'type': 'string'}, 'headline': {'maxLength': 100, 'minLength': 5, 'type': 'string'}, 'primary_text': {'maxLength': 1200, 'minLength': 50, 'type': 'string'}}, 'required': ['angle', 'primary_text', 'headline', 'description', 'cta'], 'type': 'object'}, 'maxItems': 3, 'minItems': 3, 'type': 'array'}, 'campaign_summary': {'maxLength': 700, 'minLength': 20, 'type': 'string'}, 'compliance_notes': {'items': {'maxLength': 360, 'minLength': 8, 'type': 'string'}, 'maxItems': 6, 'minItems': 1, 'type': 'array'}, 'testing_notes': {'items': {'maxLength': 360, 'minLength': 8, 'type': 'string'}, 'maxItems': 8, 'minItems': 2, 'type': 'array'}}, 'required': ['campaign_summary', 'ads', 'testing_notes', 'compliance_notes'], 'type': 'object'}
...
def create_fastapi_app(
    ...
    *,
    ...
    web = FastAPI(title='facebook-ads-copywriter', version='0.1.0')
