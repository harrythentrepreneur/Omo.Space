"""Generated Modal contract runtime for phonics-rule-explainer.
...
APP_NAME = 'cognition-phonics-rule-explainer'
WORKFLOW_VERSION = 'phonics-rule-explainer@0.1.0'
EXECUTION_KIND = 'single_llm'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/phonics_rule_explainer')
...
def create_fastapi_app(
    ...
    *,
    ...
    web = FastAPI(title='phonics-rule-explainer', version='0.1.0')
