"""Generated Modal contract runtime for Incident Route Classifier Canary.
...
APP_NAME = 'cognition-incident-route-classifier-canary'
WORKFLOW_VERSION = 'incident-route-classifier-canary@1.0.0'
EXECUTION_KIND = 'single_llm'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/incident_route_classifier_canary')
...
LIVE_MODEL_OUTPUT_SCHEMA = {'additionalProperties': False, 'properties': {'rationale': {'maxLength': 240, 'minLength': 10, 'type': 'string'}, 'route': {'enum': ['billing', 'reliability', 'security', 'support'], 'maxLength': 11, 'type': 'string'}}, 'required': ['rationale', 'route'], 'type': 'object'}
...
def create_fastapi_app(
    ...
    *,
    ...
    web = FastAPI(title='Incident Route Classifier Canary', version='1.0.0')
