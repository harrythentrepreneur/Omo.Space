"""Generated Modal contract runtime for V02 Support Urgency Classifier.
...
APP_NAME = 'cognition-v02-support-urgency-classifier'
WORKFLOW_VERSION = 'v02-support-urgency-classifier@1.0.0'
EXECUTION_KIND = 'single_llm'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/v02_support_urgency_classifier')
...
LIVE_MODEL_OUTPUT_SCHEMA = {'additionalProperties': False, 'properties': {'reason': {'maxLength': 200, 'minLength': 10, 'type': 'string'}, 'urgency': {'enum': ['high', 'low', 'medium'], 'maxLength': 6, 'minLength': 3, 'type': 'string'}}, 'required': ['reason', 'urgency'], 'type': 'object'}
...
def create_fastapi_app(
    ...
    *,
    ...
    web = FastAPI(title='V02 Support Urgency Classifier', version='1.0.0')
