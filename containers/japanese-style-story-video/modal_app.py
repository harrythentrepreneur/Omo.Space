"""Generated Modal contract runtime for japanese-style-story-video.
...
WORKFLOW_VERSION = 'japanese-style-story-video@0.1.0'
...
def create_fastapi_app(
    ...
    *,
    ...
    web = FastAPI(title='japanese-style-story-video', version='0.1.0')
