"""Generated Modal contract runtime for digraph-spotter.
...
APP_NAME = 'cognition-digraph-spotter'
WORKFLOW_VERSION = 'digraph-spotter@0.1.0'
EXECUTION_KIND = 'single_llm'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/digraph_spotter')
...
def create_fastapi_app(
    ...
    *,
    ...
    web = FastAPI(title='digraph-spotter', version='0.1.0')
