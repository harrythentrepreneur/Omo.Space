"""Generated Modal contract runtime for phonics-story-edit-studio.
...
APP_NAME = 'cognition-phonics-story-edit-studio'
WORKFLOW_VERSION = 'phonics-story-edit-studio@0.1.0'
EXECUTION_KIND = 'complex_external'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/phonics_story_edit_studio')
...
def create_fastapi_app(
    ...
    *,
    ...
    web = FastAPI(title='phonics-story-edit-studio', version='0.1.0')
