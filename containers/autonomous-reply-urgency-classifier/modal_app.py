...
LIVE_MODEL_OUTPUT_SCHEMA = {'additionalProperties': False, 'properties': {'reason': {'maxLength': 180, 'minLength': 10, 'type': 'string'}, 'urgency': {'enum': ['high', 'low', 'medium'], 'maxLength': 6, 'type': 'string'}}, 'required': ['reason', 'urgency'], 'type': 'object'}
