"""Generated Modal contract runtime for Autonomous Reply Urgency Classifier.
...
APP_NAME = 'cognition-autonomous-reply-urgency-classifier'
WORKFLOW_VERSION = 'autonomous-reply-urgency-classifier@1.0.0'
EXECUTION_KIND = 'single_llm'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/autonomous_reply_urgency_classifier')
...
LIVE_MODEL_OUTPUT_SCHEMA = {'additionalProperties': False, 'properties': {'reason': {'maxLength': 180, 'minLength': 10, 'type': 'string'}, 'urgency': {'enum': ['high', 'low', 'medium'], 'maxLength': 6, 'minLength': 3, 'type': 'string'}}, 'required': ['reason', 'urgency'], 'type': 'object'}
LIVE_STRICT_AUTHORED_OUTPUT = True
LIVE_LOCK_REVIEWED_PROVIDER = True
...
def create_fastapi_app(
    ...
    *,
    ...
    web = FastAPI(title='Autonomous Reply Urgency Classifier', version='1.0.0')
