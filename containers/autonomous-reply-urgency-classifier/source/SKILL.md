...
Build a bounded `single_llm` workflow using the platform-owned Gemini provider for one customer message. This is the third-generation unattended production proof.
