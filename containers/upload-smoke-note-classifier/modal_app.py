"""Generated Modal contract runtime for Upload Smoke Note Classifier.
...
APP_NAME = 'cognition-upload-smoke-note-classifier'
WORKFLOW_VERSION = 'upload-smoke-note-classifier@1.0.0'
EXECUTION_KIND = 'single_llm'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/upload_smoke_note_classifier')
...
LIVE_MODEL_OUTPUT_SCHEMA = {'additionalProperties': False, 'properties': {'label': {'enum': ['action_needed', 'informational', 'urgent'], 'maxLength': 15, 'minLength': 1, 'type': 'string'}, 'reason': {'maxLength': 160, 'minLength': 10, 'type': 'string'}}, 'required': ['label', 'reason'], 'type': 'object'}
...
def create_fastapi_app(
    ...
    *,
    ...
    web = FastAPI(title='Upload Smoke Note Classifier', version='1.0.0')
