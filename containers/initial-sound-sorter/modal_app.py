"""Generated Modal contract runtime for initial-sound-sorter.
...
APP_NAME = 'cognition-initial-sound-sorter'
WORKFLOW_VERSION = 'initial-sound-sorter@0.1.0'
EXECUTION_KIND = 'single_llm'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/initial_sound_sorter')
...
LIVE_MODEL_OUTPUT_SCHEMA = {'$schema': 'https://json-schema.org/draft/2020-12/schema', 'type': 'object', 'additionalProperties': False, 'properties': {'grouped': {'type': 'array', 'minItems': 1, 'maxItems': 24, 'items': {'type': 'object', 'additionalProperties': False, 'properties': {'label': {'type': 'string', 'minLength': 1, 'maxLength': 40}, 'initial_sound': {'type': 'string', 'minLength': 1, 'maxLength': 24}, 'items': {'type': 'array', 'minItems': 1, 'maxItems': 24, 'items': {'type': 'string', 'minLength': 1, 'maxLength': 40}}}, 'required': ['label', 'initial_sound', 'items']}}, 'warnings': {'type': 'array', 'maxItems': 8, 'items': {'type': 'string', 'minLength': 1, 'maxLength': 240}}}, 'required': ['grouped', 'warnings']}
...
def create_fastapi_app(
    ...
    *,
    ...
    web = FastAPI(title='initial-sound-sorter', version='0.1.0')
