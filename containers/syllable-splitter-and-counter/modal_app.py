...
SEMANTIC_NORMALIZERS = {'syllable_validation': {'input_words_field': 'words', 'input_notation_field': 'notation', 'output_items_field': 'items', 'word_field': 'word', 'syllabified_field': 'syllabified', 'count_field': 'syllable_count', 'notation_separators': {'hyphen': '-', 'dots': '.'}, 'accepted_separator_chars': ['-', '.', '·', '•', '‧', '∙', '⋅']}}
