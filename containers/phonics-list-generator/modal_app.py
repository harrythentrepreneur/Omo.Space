...
Generated by skill-to-modal/0.2.2; change the profile/compiler, not this file.
...
SEMANTIC_NORMALIZERS = {'phoneme_containment': {'phoneme_to_graphemes': {'ai': ['ai'], 'ay': ['ay'], 'ch': ['ch'], 'ee': ['ee'], 'sh': ['sh'], 'th': ['th']}}}
