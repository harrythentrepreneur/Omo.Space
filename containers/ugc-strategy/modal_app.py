"""Generated Modal contract runtime for ugc-strategy.
...
APP_NAME = 'cognition-ugc-strategy'
WORKFLOW_VERSION = 'ugc-strategy@0.1.0'
EXECUTION_KIND = 'single_llm'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/ugc_strategy')
...
LIVE_MAX_TOKENS = 2800
LIVE_TEMPERATURE = 0.25
LIVE_TIMEOUT_SECONDS = 120
LIVE_INPUT_RATE_PER_MILLION = 0.14
LIVE_OUTPUT_RATE_PER_MILLION = 0.42
LIVE_MODEL_OUTPUT_SCHEMA = {'additionalProperties': False, 'properties': {'content_system': {'items': {'additionalProperties': False, 'properties': {'cadence': {'description': 'Suggested cadence, explicitly framed as a plan.', 'maxLength': 160, 'minLength': 3, 'title': 'Cadence', 'type': 'string'}, 'owner': {'description': 'Suggested owner.', 'maxLength': 120, 'minLength': 3, 'title': 'Owner', 'type': 'string'}, 'trigger': {'description': 'Moment or prompt that can generate content.', 'maxLength': 350, 'minLength': 8, 'title': 'Trigger', 'type': 'string'}, 'type': {'description': 'Content type.', 'enum': ['organic', 'incentivized', 'creator', 'review'], 'title': 'UGC type'}, 'use': {'description': 'How the content is used.', 'maxLength': 350, 'minLength': 8, 'title': 'Use', 'type': 'string'}}, 'required': ['type', 'trigger', 'use', 'owner', 'cadence'], 'title': 'UGC system item', 'type': 'object'}, 'maxItems': 7, 'minItems': 1, 'title': 'Content system', 'type': 'array'}, 'creator_brief': {'additionalProperties': False, 'properties': {'deliverables': {'items': {'description': 'Requested content deliverable.', 'maxLength': 280, 'minLength': 8, 'title': 'Deliverable', 'type': 'string'}, 'maxItems': 6, 'minItems': 1, 'title': 'Deliverables', 'type': 'array'}, 'do': {'items': {'description': 'Include this.', 'maxLength': 280, 'minLength': 8, 'title': 'Do', 'type': 'string'}, 'maxItems': 6, 'minItems': 1, 'title': 'Do', 'type': 'array'}, 'dont': {'items': {'description': 'Avoid this.', 'maxLength': 280, 'minLength': 8, 'title': 'Do not', 'type': 'string'}, 'maxItems': 8, 'minItems': 1, 'title': 'Do not', 'type': 'array'}, 'hook_options': {'items': {'description': 'A creator hook grounded in supplied facts.', 'maxLength': 250, 'minLength': 8, 'title': 'Hook option', 'type': 'string'}, 'maxItems': 3, 'minItems': 3, 'title': 'Hook options', 'type': 'array'}, 'key_message': {'description': 'One message the creator must communicate.', 'maxLength': 500, 'minLength': 8, 'title': 'Key message', 'type': 'string'}, 'usage_rights_prompt': {'description': 'Plain-language rights question for the brief/contract.', 'maxLength': 500, 'minLength': 8, 'title': 'Usage rights prompt', 'type': 'string'}}, 'required': ['hook_options', 'key_message', 'do', 'dont', 'deliverables', 'usage_rights_prompt'], 'title': 'Creator brief', 'type': 'object'}, 'next_14_days': {'items': {'description': 'A concrete next action for the next 14 days.', 'maxLength': 350, 'minLength': 8, 'title': 'Next action', 'type': 'string'}, 'maxItems': 10, 'minItems': 3, 'title': 'Next 14 days', 'type': 'array'}, 'paid_ad_plan': {'items': {'additionalProperties': False, 'properties': {'disclosure': {'description': 'Disclosure reminder.', 'maxLength': 300, 'minLength': 8, 'title': 'Disclosure', 'type': 'string'}, 'format': {'description': 'UGC ad format.', 'maxLength': 160, 'minLength': 3, 'title': 'Format', 'type': 'string'}, 'hook_test': {'description': 'A testable hook variation.', 'maxLength': 300, 'minLength': 8, 'title': 'Hook test', 'type': 'string'}, 'proof_requirement': {'description': 'What must be visibly or verbally supported.', 'maxLength': 400, 'minLength': 8, 'title': 'Proof requirement', 'type': 'string'}}, 'required': ['format', 'hook_test', 'proof_requirement', 'disclosure'], 'title': 'Paid UGC plan', 'type': 'object'}, 'maxItems': 6, 'minItems': 1, 'title': 'Paid ad plan', 'type': 'array'}, 'review_plan': {'items': {'description': 'A review-generation or review-hygiene step.', 'maxLength': 400, 'minLength': 8, 'title': 'Review plan step', 'type': 'string'}, 'maxItems': 6, 'minItems': 1, 'title': 'Review plan', 'type': 'array'}, 'rights_and_compliance': {'items': {'description': 'Rights, disclosure, or legal review point.', 'maxLength': 450, 'minLength': 8, 'title': 'Rights and compliance', 'type': 'string'}, 'maxItems': 8, 'minItems': 1, 'title': 'Rights and compliance', 'type': 'array'}, 'strategy_summary': {'description': 'Overall UGC system summary.', 'maxLength': 1000, 'minLength': 8, 'title': 'Strategy summary', 'type': 'string'}}, 'required': ['strategy_summary', 'content_system', 'creator_brief', 'paid_ad_plan', 'review_plan', 'rights_and_compliance', 'next_14_days'], 'title': 'UGC Strategy Planner provider result', 'type': 'object'}
...
def create_fastapi_app(
    ...
    *,
    ...
    web = FastAPI(title='ugc-strategy', version='0.1.0')
