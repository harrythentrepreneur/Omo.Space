...
LIVE_MODEL_OUTPUT_SCHEMA = {'$schema': 'https://json-schema.org/draft/2020-12/schema', 'additionalProperties': False, 'properties': {'product_name': {'maxLength': 160, 'minLength': 1, 'type': 'string'}, 'goal': {'enum': ['product_improvement', 'marketing_insights', 'retention'], 'type': 'string'}, 'summary': {'maxLength': 1200, 'minLength': 1, 'type': 'string'}, 'themes': {'items': {'additionalProperties': False, 'properties': {'name': {'maxLength': 120, 'minLength': 1, 'type': 'string'}, 'sentiment': {'enum': ['positive', 'negative', 'mixed', 'neutral'], 'type': 'string'}, 'priority': {'enum': ['high', 'medium', 'low'], 'type': 'string'}, 'support_count': {'maximum': 100, 'minimum': 1, 'type': 'integer'}, 'comment_indexes': {'items': {'maximum': 99, 'minimum': 0, 'type': 'integer'}, 'maxItems': 100, 'minItems': 1, 'type': 'array', 'uniqueItems': True}, 'evidence_quotes': {'items': {'additionalProperties': False, 'properties': {'comment_index': {'maximum': 99, 'minimum': 0, 'type': 'integer'}, 'quote': {'maxLength': 4000, 'minLength': 1, 'type': 'string'}}, 'required': ['comment_index', 'quote'], 'type': 'object'}, 'maxItems': 2, 'type': 'array'}, 'priority_reason': {'maxLength': 360, 'minLength': 1, 'type': 'string'}}, 'required': ['name', 'sentiment', 'priority', 'support_count', 'comment_indexes', 'evidence_quotes', 'priority_reason'], 'type': 'object'}, 'maxItems': 8, 'type': 'array'}, 'recommended_actions': {'items': {'additionalProperties': False, 'properties': {'action': {'maxLength': 500, 'minLength': 1, 'type': 'string'}, 'based_on_themes': {'items': {'maxLength': 120, 'minLength': 1, 'type': 'string'}, 'maxItems': 8, 'minItems': 1, 'type': 'array', 'uniqueItems': True}, 'confidence': {'enum': ['high', 'medium', 'low'], 'type': 'string'}, 'success_signal': {'maxLength': 500, 'minLength': 1, 'type': 'string'}}, 'required': ['action', 'based_on_themes', 'confidence', 'success_signal'], 'type': 'object'}, 'maxItems': 5, 'type': 'array'}, 'limitations': {'items': {'maxLength': 500, 'minLength': 1, 'type': 'string'}, 'maxItems': 8, 'minItems': 1, 'type': 'array'}}, 'required': ['product_name', 'goal', 'summary', 'themes', 'recommended_actions', 'limitations'], 'type': 'object'}
