"""Generated pure-data parity runtime for v02-release-label-sorter@1.0.0."""
...
APP_NAME = 'cognition-v02-release-label-sorter'
WORKFLOW_VERSION = 'v02-release-label-sorter@1.0.0'
PROFILE_VERSION = '1.0.0'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/v02_release_label_sorter')
