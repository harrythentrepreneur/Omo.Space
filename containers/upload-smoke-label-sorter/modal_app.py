"""Generated pure-data parity runtime for upload-smoke-label-sorter@1.0.0."""
...
APP_NAME = 'cognition-upload-smoke-label-sorter'
WORKFLOW_VERSION = 'upload-smoke-label-sorter@1.0.0'
PROFILE_VERSION = '1.0.0'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/upload_smoke_label_sorter')
