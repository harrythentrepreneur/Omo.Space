"""Generated Modal contract runtime for phoneme-counter.
...
APP_NAME = 'cognition-phoneme-counter'
WORKFLOW_VERSION = 'phoneme-counter@0.1.0'
EXECUTION_KIND = 'single_llm'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/phoneme_counter')
...
LIVE_MODEL_OUTPUT_SCHEMA = {'$schema': 'https://json-schema.org/draft/2020-12/schema', 'type': 'object', 'additionalProperties': False, 'properties': {'word': {'type': 'string', 'minLength': 1, 'maxLength': 80}, 'dialect': {'enum': ['en-US', 'en-GB', 'en-AU']}, 'phonemes': {'type': 'array', 'items': {'type': 'string', 'minLength': 1, 'maxLength': 20}, 'minItems': 1, 'maxItems': 30}, 'phoneme_count': {'type': 'integer', 'minimum': 1, 'maximum': 30}, 'ipa': {'type': 'string', 'maxLength': 120}, 'uncertainty': {'type': 'string', 'minLength': 1, 'maxLength': 300}}, 'required': ['word', 'dialect', 'phonemes', 'phoneme_count', 'uncertainty']}
SEMANTIC_NORMALIZERS = {'flag_fields': [{'flag': 'show_transcription', 'path': ['ipa']}]}
...
def create_fastapi_app(
    ...
    *,
    ...
    web = FastAPI(title='phoneme-counter', version='0.1.0')
