"""Generated Modal contract runtime for decodable-sentence-creator.
...
APP_NAME = 'cognition-decodable-sentence-creator'
WORKFLOW_VERSION = 'decodable-sentence-creator@0.1.0'
EXECUTION_KIND = 'single_llm'
LOCAL_ROOT = Path(__file__).resolve().parent
IMAGE_ROOT = Path('/root/decodable_sentence_creator')
...
LIVE_MODEL_OUTPUT_SCHEMA = {'$schema': 'https://json-schema.org/draft/2020-12/schema', 'type': 'object', 'additionalProperties': False, 'properties': {'sentences': {'type': 'array', 'minItems': 1, 'maxItems': 5, 'items': {'type': 'object', 'additionalProperties': False, 'properties': {'text': {'type': 'string', 'minLength': 3, 'maxLength': 160}, 'target_words': {'type': 'array', 'items': {'type': 'string', 'minLength': 1, 'maxLength': 40}, 'minItems': 1, 'maxItems': 20}, 'sight_or_irregular_words': {'type': 'array', 'items': {'type': 'string', 'minLength': 1, 'maxLength': 40}, 'maxItems': 20}}, 'required': ['text', 'target_words']}}, 'coverage': {'type': 'array', 'items': {'type': 'string', 'minLength': 1, 'maxLength': 40}, 'minItems': 1, 'maxItems': 6, 'uniqueItems': True}, 'warnings': {'type': 'array', 'items': {'type': 'string', 'minLength': 1, 'maxLength': 240}, 'maxItems': 8}}, 'required': ['sentences', 'coverage', 'warnings']}
SEMANTIC_NORMALIZERS = {'flag_fields': [{'flag': 'include_sight_words', 'path': ['sentences', '*', 'sight_or_irregular_words']}], 'target_word_containment': {'request_field': 'phonics_patterns', 'items_field': 'sentences', 'target_field': 'target_words', 'pattern_to_word_shape': {'cvc': 'CVC', 'ccvc': 'CCVC', 'cvcc': 'CVCC'}, 'pattern_to_graphemes': {'long_a': ['ai', 'ay', 'a_e'], 'long_e': ['ee', 'ea', 'e_e', 'y'], 'long_i': ['igh', 'ie', 'i_e', 'y'], 'long_o': ['oa', 'ow', 'o_e'], 'long_u': ['ue', 'ew', 'u_e'], 'sh_digraph': ['sh'], 'ch_digraph': ['ch'], 'th_digraph': ['th'], 'wh_digraph': ['wh'], 'ck_digraph': ['ck'], 'ai_vowel_team': ['ai'], 'ee_vowel_team': ['ee'], 'oa_vowel_team': ['oa']}}}
...
def create_fastapi_app(
    ...
    *,
    ...
    web = FastAPI(title='decodable-sentence-creator', version='0.1.0')
